...
export default function MarketingPlan() {
  ...
  return (
    <section id="marketing" className="py-24 bg-[#0f172a]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimateIn>
          <div className="text-center mb-16">
            <span className="text-green-400 text-sm font-semibold uppercase tracking-widest mb-3 block">Go-to-Market</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {strategies.map((s, i) => (
            <AnimateIn key={s.title} delay={i * 120}>
