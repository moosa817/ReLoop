  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(ellipse 60% 40% at 50% 60%, rgba(22,163,74,0.18) 0%, transparent 70%)",
        }}
      />
      {/* Teal glow top-right */}
      <div
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-24 pb-16">
        ...
        {/* Headline */}
        <h1 className="text-5xl sm:text-6xl lg:text-8xl font-black mb-6 leading-tight animate-fade-in-up delay-100">
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-400 via-emerald-300 to-cyan-400">
            Get Paid for Trash
          </span>
        </h1>

        <p className="text-lg sm:text-xl lg:text-2xl text-gray-300 max-w-3xl mx-auto mb-10 leading-relaxed animate-fade-in-up delay-200">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16 animate-fade-in-up delay-300">
          <a
            href="#cta"
            className="bg-green-600 hover:bg-green-500 text-white font-bold px-8 py-4 rounded-xl text-lg transition-all duration-200 hover:shadow-lg hover:shadow-green-500/30 hover:-translate-y-0.5 focus-visible:ring-2 focus-visible:ring-green-400"
          >
            Join the Revolution
          </a>
          <a
            href="#product"
            className="bg-white/10 hover:bg-white/20 text-white font-bold px-8 py-4 rounded-xl text-lg border border-white/20 transition-all duration-200 hover:-translate-y-0.5 backdrop-blur-sm focus-visible:ring-2 focus-visible:ring-white/40"
          >
            See How It Works
          </a>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in-up delay-400">
          {[
            ...
            <div
              key={stat.value}
              className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl px-6 py-4 hover:bg-white/10 hover:border-green-500/20 transition-colors"
            >
